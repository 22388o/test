...
{
    transaction* simplicityTxData = nullptr;
...
public:
    ...
    virtual bool CheckSimplicity(const std::vector<unsigned char>& witness, const std::vector<unsigned char>& program, const rawTapEnv& simplicityRawTap, ScriptError* serror) const
    {
         return false;
    }
...
public:
    ...
    bool CheckSimplicity(const std::vector<unsigned char>& witness, const std::vector<unsigned char>& program, const rawTapEnv& simplicityRawTap, ScriptError* serror) const override;
};
